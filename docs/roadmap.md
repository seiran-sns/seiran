...
- [x] **pg_bigmによる検索のパフォーマンス向上（#97）** — PostgreSQL 16へpg_bigmを組み込む専用Dockerイメージを追加し、投稿本文・アクター名・acct形式の部分一致検索を`LOWER(...) LIKE LOWER(...)`とbigm GINインデックスの組み合わせへ移行。詳細: `docs/architecture.md`、`docs/database.md`
