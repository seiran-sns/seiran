...
- `components/right/` — 右ペインのタブ内容（`NotificationsPanel`、`TrendsSearchPanel`、`FollowListPanel`、`AuthorPanel`（ポスト詳細画面の「投稿者」タブ。投稿主のプロフィール概要と固定ポストを表示、`docs/ui_spec.md` 2.3参照））
